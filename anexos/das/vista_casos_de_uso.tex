    ...
    \begin{figure}[H]
        \includegraphics[width=.9\textwidth,height=.9\textheight,keepaspectratio]{cu_customer_staff_pagos.png}
    ...
    \begin{figure}[H]
        \includegraphics[width=.9\textwidth,height=.9\textheight,keepaspectratio]{cu_customer_staff_administracion.png}
