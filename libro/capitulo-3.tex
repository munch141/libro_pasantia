...
\section{Frameworks}
    ...
    \subsection{Bootstrap} es un framework de front end de código abierto diseñado para construir sitios y aplicaciones Web. Fue utilizado para construir las vistas de la aplicación.
